...
以前制作した[littlebird-site](https://github.com/littlebirdjp/littlebird-site)のLESSファイルを流用して、WPサイトと[本サイト](http://littlebird.mobi/blog)を統合。最終的にはStaticPressで静的化してS3に公開するところまで持っていきたいと思っています。
